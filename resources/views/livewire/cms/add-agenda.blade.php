    ...
    handle.style.cursor='se-resize';
      ...
      ">
            ...
            <div class="mt-4">
                ...
                <div @if($lang !=='id' ) style="display:none" @endif>
                    <input
                        type="file"
                        wire:model="file_id"
                        wire:key="file_id_input_id" {{-- key unik untuk ID --}}
                        accept=".pdf,.doc,.docx"
                        class="w-full border p-2">
                    @error('file_id')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                ...
                <div @if($lang !=='en' ) style="display:none" @endif>
                    <input
                        type="file"
                        wire:model="file_en"
                        wire:key="file_en_input_en" {{-- key unik untuk EN --}}
                        accept=".pdf,.doc,.docx"
                        class="w-full border p-2">
                    @error('file_en')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
